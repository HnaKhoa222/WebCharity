...
const ProjectsPage = () => {
  ...
  const { toggleInterest, isInterested, loading: interestLoading } = useInterest();
          ...
          filteredProjects.map((project) => (
            <div key={project.id} className="project-item">
              ...
              <button
                ...
                className={`interest-btn ${isInterested(project.id) ? "interested" : ""}`}
                title={
                  !currentUser
                    ? "Vui lòng đăng nhập để sử dụng chức năng quan tâm"
              ...
              <div className="progress-info">
                <span className="amount">Đã nhận: {project.raisedAmount}</span>
                <span className="target">Mục tiêu: {project.fundingGoal}</span>
              </div>
