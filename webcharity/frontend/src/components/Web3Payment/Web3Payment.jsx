...
const Web3Payment = () => {
  ...
  const handleDonation = async () => {
    ...
    try {
      ...
      const amountInWei = ethers.utils.parseEther(fixedAmount);
      ...
      await updateDoc(doc(db, 'projects', projectId), {
        totalDonations: increment(parseFloat(fixedAmount)),
        donations: arrayUnion(donationData)
      });
      ...
      setProject(prev => ({
        ...prev,
        totalDonations: (parseFloat(prev.totalDonations) + parseFloat(fixedAmount)).toString()
      }));
    ...
    <div className="web3-payment">
      ...
      <div className="payment-form">
        ...
        <div className="amount-section">
          <p className="fixed-amount">Số tiền quyên góp: 0.001 ETH</p>
        </div>
        ...
        >
          {loading ? 'Đang xử lý...' : 'Quyên góp 0.001 ETH'}
        </button>
